        ...
        <div className="flex items-center justify-between h-16 gap-3">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <button
              ...
              className="flex items-center gap-2.5 text-left group focus:outline-hidden rounded-lg"
            >
          ...
          {/* Right Action Controls: Simple/Detailed Toggle, Language, Sound, Theme */}
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="hidden sm:inline">
                {isSimpleMode ? t.simpleModeOn : t.simpleModeOff}
              </span>
            </button>
            ...
            <button
              ...
              className="px-2.5 py-1.5 text-xs font-bold rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/80 text-slate-700 dark:text-slate-200 hover:bg-slate-100 transition-colors flex items-center gap-1"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl border transition-all text-xs font-semibold border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/80 hover:bg-slate-100 dark:hover:bg-slate-700/60"
            >
              {isDarkMode ? (
                <>
